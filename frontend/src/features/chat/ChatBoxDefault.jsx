  ...
  return (
    <div className="col-span-3 flex items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-1">
        ...
        {/* Chat Icon */}
        <h3 className="text-lg">Your Messages</h3>
        <h4 className="text-xs text-gray-400">
          Send private photos and messages to a friend or group
        </h4>
        <Modal.Button
          opens="start-conversation"
          className="mt-2 w-fit rounded-xl bg-sky-500 px-4 py-1.5 text-sm font-semibold text-white hover:bg-blue-600"
        >
          Send message
        </Modal.Button>
      </div>
