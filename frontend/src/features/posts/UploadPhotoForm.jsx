        ...
        <>
          ...
          <div className="relative">
            <input
              type="file"
              accept="image/*,video/*"
              className="peer absolute inset-0 m-0 cursor-pointer p-0 opacity-0 file:m-0 file:cursor-pointer file:p-0"
              onChange={(e) => {
            ...
            />
            <Button
              className="w-fit bg-sky-500 px-4 peer-hover:bg-blue-600"
              disabled={isLoading}
            >
